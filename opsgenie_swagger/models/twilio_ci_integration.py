...
class TwilioCIIntegration(object):
    ...
    def __init__(self, suppress_notifications=None, ignore_teams_from_payload=None, ignore_recipients_from_payload=None, recipients=None, is_advanced=None, feature_type=None, allow_configuration_access=None, allow_write_access=None):  # noqa: E501
        """TwilioCIIntegration - a model defined in Swagger"""  # noqa: E501
    ...
    def suppress_notifications(self):
        """Gets the suppress_notifications of this TwilioCIIntegration.  # noqa: E501

        If enabled, notifications that come from alerts will be suppressed. Defaults to false  # noqa: E501

        :return: The suppress_notifications of this TwilioCIIntegration.  # noqa: E501
        :rtype: bool
        """
    ...
    def suppress_notifications(self, suppress_notifications):
        """Sets the suppress_notifications of this TwilioCIIntegration.

        If enabled, notifications that come from alerts will be suppressed. Defaults to false  # noqa: E501

        :param suppress_notifications: The suppress_notifications of this TwilioCIIntegration.  # noqa: E501
        :type: bool
        """
    ...
    def ignore_teams_from_payload(self):
        """Gets the ignore_teams_from_payload of this TwilioCIIntegration.  # noqa: E501

        If enabled, the integration will ignore teams sent in request payloads. Defaults to false  # noqa: E501

        :return: The ignore_teams_from_payload of this TwilioCIIntegration.  # noqa: E501
        :rtype: bool
        """
    ...
    def ignore_teams_from_payload(self, ignore_teams_from_payload):
        """Sets the ignore_teams_from_payload of this TwilioCIIntegration.

        If enabled, the integration will ignore teams sent in request payloads. Defaults to false  # noqa: E501

        :param ignore_teams_from_payload: The ignore_teams_from_payload of this TwilioCIIntegration.  # noqa: E501
        :type: bool
        """
    ...
    def ignore_recipients_from_payload(self):
        """Gets the ignore_recipients_from_payload of this TwilioCIIntegration.  # noqa: E501

        If enabled, the integration will ignore recipients sent in request payloads. Defaults to false  # noqa: E501

        :return: The ignore_recipients_from_payload of this TwilioCIIntegration.  # noqa: E501
        :rtype: bool
        """
    ...
    def ignore_recipients_from_payload(self, ignore_recipients_from_payload):
        """Sets the ignore_recipients_from_payload of this TwilioCIIntegration.

        If enabled, the integration will ignore recipients sent in request payloads. Defaults to false  # noqa: E501

        :param ignore_recipients_from_payload: The ignore_recipients_from_payload of this TwilioCIIntegration.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def recipients(self):
        """Gets the recipients of this TwilioCIIntegration.  # noqa: E501
        ...
        :return: The recipients of this TwilioCIIntegration.  # noqa: E501
    ...
    def recipients(self, recipients):
        """Sets the recipients of this TwilioCIIntegration.

        Optional user, schedule, teams or escalation names to calculate which users will receive the notifications of the alert. Recipients which are exceeding the limit are ignored  # noqa: E501

        :param recipients: The recipients of this TwilioCIIntegration.  # noqa: E501
        :type: list[Recipient]
        """
    ...
    def is_advanced(self):
        """Gets the is_advanced of this TwilioCIIntegration.  # noqa: E501


        :return: The is_advanced of this TwilioCIIntegration.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_advanced(self, is_advanced):
        """Sets the is_advanced of this TwilioCIIntegration.


        :param is_advanced: The is_advanced of this TwilioCIIntegration.  # noqa: E501
        :type: bool
        """
    ...
    def feature_type(self):
        """Gets the feature_type of this TwilioCIIntegration.  # noqa: E501


        :return: The feature_type of this TwilioCIIntegration.  # noqa: E501
        :rtype: str
        """
    ...
    def feature_type(self, feature_type):
        """Sets the feature_type of this TwilioCIIntegration.


        :param feature_type: The feature_type of this TwilioCIIntegration.  # noqa: E501
        :type: str
        """
    ...
    def allow_configuration_access(self):
        """Gets the allow_configuration_access of this TwilioCIIntegration.  # noqa: E501
        ...
        :return: The allow_configuration_access of this TwilioCIIntegration.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_configuration_access(self, allow_configuration_access):
        """Sets the allow_configuration_access of this TwilioCIIntegration.

        This parameter is for allowing or restricting the configuration access. If configuration access is restricted, the integration will be limited to Alert API requests and sending heartbeats. Defaults to false  # noqa: E501

        :param allow_configuration_access: The allow_configuration_access of this TwilioCIIntegration.  # noqa: E501
        :type: bool
        """
    ...
    def allow_write_access(self):
        """Gets the allow_write_access of this TwilioCIIntegration.  # noqa: E501
        ...
        :return: The allow_write_access of this TwilioCIIntegration.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_write_access(self, allow_write_access):
        """Sets the allow_write_access of this TwilioCIIntegration.

        This parameter is for configuring the read-only access of integration. If the integration is limited to read-only access, the integration will not be authorized to perform any create, update or delete action within any domain. Defaults to true  # noqa: E501

        :param allow_write_access: The allow_write_access of this TwilioCIIntegration.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TwilioCIIntegration):
            return False
